...
export class NotificationsService {
  ...
  constructor() { }
    ...
    showNotification(message: any, type: any = 'rose') {
        const typeList = ['', 'info', 'success', 'warning', 'danger', 'rose', 'primary'];
        ...
        $.notify({
            ...
            template: '<div data-notify="container" class="col-xs-11 col-sm-3 alert alert-{0} alert-with-icon showAbove" role="alert">' +
